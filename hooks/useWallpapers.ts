...
export function useWallpapers(): FullWallpaper[] {
  return [
    {
      uri: "https://ideogram.ai/assets/progressive-image/balanced/response/grtS8AsZRGyLm3VJ2SHS7g",
      name: "Heritage",
      liked: true,
      suggested: true,
      library: false,
    ...
    {
      uri: "https://ideogram.ai/assets/progressive-image/balanced/response/0reS7n7eRfClLKHIEiWJUw",
      name: "Late night",
      liked: true,
      suggested: false,
      library: true,
    ...
    {
      uri: "https://ideogram.ai/assets/progressive-image/balanced/response/O0l3cIsdSJm7CRjGqrb5-Q",
      name: "Motivation",
      liked: false,
      suggested: true,
      library: false,
    ...
    {
      uri: "https://ideogram.ai/assets/progressive-image/balanced/response/6n67jVOxTRW0-xEqMpLw9A",
      name: "Night sky",
      liked: false,
      suggested: true,
      library: false,
    ...
    {
      uri: "https://ideogram.ai/assets/progressive-image/balanced/response/IfLz4vd4Tfy5fnBlMN0cLA",
      name: "Sunrise",
      liked: false,
      suggested: true,
      library: false,
